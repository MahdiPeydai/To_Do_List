...
from To_Do_List.helpers.forms import RegisterForm
from To_Do_List.helpers.forms import LoginForm
import hashlib
import json
import jwt
...
def login():
    ...
    if request.method == 'POST':
        ...
        with open('To_Do_List/data/users_information.json', 'r+') as information_file:
...
def register():
    ...
    if request.method == 'POST' and form.validate():
        ...
        with open("To_Do_List/data/users_information.json", 'w+') as information_file:
